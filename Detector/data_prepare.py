...
def arg_parse():
    ...
    parser.add_argument('--train_ratio', type=float, default=1,
                        help='The ratio of the train set when splitting the train set and the validation set')
...
def generate_cross_validation_txt(root):
    ...
    for i, validation_set in enumerate(cross_validation):
        ...
        generate_yaml_file(f"./detector_{validation_set}.yaml", root, f"{validation_set}_train.txt",
                           f"{validation_set}_valid.txt")
