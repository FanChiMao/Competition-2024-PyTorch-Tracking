...
from Detector.yolov9.utils import TryExcept
from Detector.yolov9_colab_usage.utils.dataloaders import exif_transpose, letterbox
from Detector.yolov9_colab_usage.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes,
                           xywh2xyxy, xyxy2xywh, yaml_load)
from Detector.yolov9_colab_usage.utils.plots import Annotator, colors, save_one_box
from Detector.yolov9_colab_usage.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from Detector.yolov9_colab_usage.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from Detector.yolov9_colab_usage.utils.triton import TritonRemoteModel
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from Detector.yolov9_colab_usage.utils.downloads import is_url
...
class AutoShape(nn.Module):
    ...
    def _apply(self, fn):
        ...
        from Detector.yolov9_colab_usage.models.yolo import Detect, Segment
        if self.pt:
            m = self.model.model.model[-1] if self.dmb else self.model.model[-1]  # Detect()
