...
from train_reid_model import AICUPDataset
...
def main():
    ...
    parser.add_argument('--weights', default=r"D:\Jonathan\AI_project\ObjectTracking\code\yolov9\ReId\log\osnet_x1_0\model\model.pth.tar-50", type=str)
    ...
    train_root = r"C:\AICUP\ReID_dataset"
    image_size = 224
